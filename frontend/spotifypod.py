...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.bt_image = ImageTk.PhotoImage(flattenAlpha(Image.open('pod_bt.png')))
        self.configure(bg=SPOT_BLACK)
    ...
    def set_header(self, header, now_playing = None, has_wifi = False, has_bt= False):
        ...
        bt_image = self.bt_image if has_bt else self.space_image
        self.bt_indicator.configure(image= bt_image)
        self.bt_indicator.image = bt_image
